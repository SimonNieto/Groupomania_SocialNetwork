          ...
          <div class="card bg-light">
            ...
            <div class="card-body bg-light" >
              ...
              >
                      ...
                      >
                        ...
                        <div class="modal-footer">
                          <div class="row w-100 justify-content-spacebetween">
                            <div class="col-6">
                              <a
                                @click="$bvModal.hide('modalAvatar')"
                                data-dismiss="modal"
                ...
                <div class="col-12 justify-content-center">
                  <b-button
                    @click="$bvModal.show('modalDeleteAccount')"
                    href=""
                    data-toggle="modal"
    ...
    disconnectAccount() {
      axios
        ...
        .then(() => {
          localStorage.clear();
          Swal.fire({
            text: "Le compte à été déconnecté !",
